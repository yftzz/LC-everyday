...
***Click on the pic to learn more about my life xD***


<a href="https://www.leetcode.com"><img src="https://github.com/YN-Tang/Works-and-practice/blob/master/Leetcode/my_life.jpeg"/></a>

<!-- resume
1. interested topic or courses
2. objective 
3. OS project 

questions
1. talk about complexity 
2. talk about why this languate (i.e. language features)
3. data strucure and algo
 -->